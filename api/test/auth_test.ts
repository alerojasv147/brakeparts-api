...
describe('# Auth', () => {
  ...
  it('should return token expired message', () => {
    return request.post(process.env.API_BASE + 'tasks')
      .set('Authorization', 'JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1MjM5MzEzNzgsInVzZXJuYW1lIjoidGVzdHVzZXIifQ.ZO4xu2EVHBj73op0uh3_a1cAz5O_AAFmhspKsDkoSRE')
      .send({
        name: 'Do the dishes'
      })
